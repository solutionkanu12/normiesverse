...
export default function HomePage() {
  return (
    <div className="relative">
      ...
      <section id="lore" className="relative px-6 sm:px-16 py-32 sm:py-40 bg-[#03040a]/95">
        {/* cinematic top + bottom fades so it reads as an interlude, not a card */}
        <div className="pointer-events-none absolute inset-x-0 top-0 h-40 bg-gradient-to-b from-transparent to-[#03040a]/95" />
        <div className="pointer-events-none absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-transparent to-[#03040a]/95" />
              ...
              <p
                ...
                className={
                  i === LORE_PARAGRAPHS.length - 1
                    ? "text-white text-lg sm:text-2xl leading-relaxed font-normal"
                    : "text-[#aebbd6] text-base sm:text-xl leading-relaxed font-light"
                }
              >
                {para}
              </p>
